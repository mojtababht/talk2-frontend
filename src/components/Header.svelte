...
<div class="header">
    ...
    <div class="user-settings">
        <div class="dark-light" on:click={darkToggle}>
        ...
        <img class="user-profile account-profile" src="{user_info.profile.avatar ? user_info.profile.avatar: avatar}" alt="avatar" >
    </div>
</div>
